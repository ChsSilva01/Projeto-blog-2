...
//Possui dois argumento GET = pegar e o segundo é a pasta do xml, e o false e por causa do get(Lê um determinado arquivo XML no diretório do projeto)
...
function funcaoConteudo(){
    for(i=x.length-1;i>=0;i--){     
        document.write(
                ...
                "<td>"+"<img src='img/"+x[i].getElementsByTagName("imagem")[0].childNodes[0].nodeValue+"' width='150'></td>" +
